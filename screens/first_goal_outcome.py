...
def _pct_row(label: str, pct: float, icon: str) -> str:
    ...
    return (
        ...
        f'<span style="color:#cbd5e1;">{icon} {label}</span>'
...
def _timeframe_column_html(
    ...
    return (
        ...
        f'padding:10px 12px;min-height:140px;">'
        ...
        f'<div style="font-size:10px;color:#94a3b8;text-align:center;margin-top:6px;">'
        f'n={p["total"]}</div></div>'
    )
...
def render_first_goal_outcome_block(
    ...
    """Tabella esito finale dopo primo gol."""
